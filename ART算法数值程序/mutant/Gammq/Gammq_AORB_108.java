package dt.mutant.Gammq;
import dt.original.*;

// This is mutant program.
// Author : ysma

public class Gammq_AORB_108 extends Gammq
{
    ...
    private double gamser;

    private double gammcf;
    ...
    private void gcf( double a, double x )
    {
        ...
        if (i > ITMAX) {
            throw new java.lang.RuntimeException( "a too large, ITMAX too small in gcf" );
        }
    ...
    private void gser( double a, double x )
    {
        ...
        if (x <= 0.0) {
            if (x < 0.0) {
                throw new java.lang.RuntimeException( "x less than 0 in routine gser" );
            }
            gamser = 0.0;
            return;
        } else {
            ...
            throw new java.lang.RuntimeException( "a too large, ITMAX too small in routine gser" );
        }
    }
    ...
    {
        if (x < 0.0 || a <= 0.0) {
            throw new java.lang.RuntimeException( "Invalid arguments in routine gammq" );
        }
        if (x < a + 1.0) {
            gser( a, x );
            return 1 - gamser;
